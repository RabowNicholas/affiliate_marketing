...
# ─────────────────────────────────────────────────────────────────────────────
# First file Claude reads every session. Registry only — pointers, no content.
# ─────────────────────────────────────────────────────────────────────────────
...
| REFERENCE.md  | Business model, constraints, voice, quality      | in-flux  | Niche/program/content/funnel/quality   |
| RESEARCH-PLAYBOOK.md | Reusable niche-validation engine          | locked   | Validating any niche / running a gap scan |
...
## SESSION PROTOCOL
# 1. ORIENT — Read INDEX.md, then ACTIVE.md.
# 2. PULL — Load REFERENCE.md for any niche/program/content/funnel/quality task.
